...
@Component({
  selector: 'app-rpusers',
  templateUrl: './rpusers.component.html',
  styleUrls: ['./rpusers.component.css'],
  providers : [SbusersService]
})
export class RpusersComponent implements OnInit {
    ...
    x.snapshotChanges().subscribe(item =>{
      ...
      item.forEach(element=> {
        ...
        if(this.num == 1 || this.num == 2) {
          if( this.name != null) {
            if(this.single_user.user_type == "Resource" && this.single_user.name.includes(this.name)) {
              y["$key"] = element.key;
              this.sbusersList.push(y as Sbusers);  
            }
          }
          else if(this.single_user.user_type == "Resource"){
            y["$key"] = element.key;
            this.sbusersList.push(y as Sbusers);  
          }
        }
          ...
          if( this.name != null) {
            if(this.single_user.user_type == "Resource" && this.single_user.name.includes(this.name) && this.single_user.status == "1") {
              y["$key"] = element.key;
              this.sbusersList.push(y as Sbusers);  
            }
          }
          else if(this.single_user.user_type == "Resource" && this.single_user.status == "1"){
            y["$key"] = element.key;
            this.sbusersList.push(y as Sbusers);  
          }
        }
          ...
          if( this.name != null) {
            if(this.single_user.user_type == "Resource" && this.single_user.name.includes(this.name) && this.single_user.status == "2") {
              y["$key"] = element.key;
              this.sbusersList.push(y as Sbusers);  
            }
          }
          else if(this.single_user.user_type == "Resource" && this.single_user.status == "2"){
            y["$key"] = element.key;
            this.sbusersList.push(y as Sbusers);  
          }
        }
          ...
          if( this.name != null) {
            if(this.single_user.user_type == "Resource" && this.single_user.name.includes(this.name) && this.single_user.status == "0") {
              y["$key"] = element.key;
              this.sbusersList.push(y as Sbusers);  
            }
          }
          else if(this.single_user.user_type == "Resource" && this.single_user.status == "0"){
            y["$key"] = element.key;
            this.sbusersList.push(y as Sbusers);  
          }
        }
